...
//		key := datastore.NewKey(ctx, "Post",)
//		if _, err := datastore.Delete(ctx, key); err != nil {
//			log.Errorf(ctx, "datastore.Delete: %v", err)
//
//			w.WriteHeader(http.StatusInternalServerError)
//			params.Notice = "Couldn't delete post. Try again?"
//			params.Message = post.Message // Preserve their message so they can try again.
//			indexTemplate.Execute(w, params)
//			return
//		}
